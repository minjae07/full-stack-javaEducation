...
public class LoggingAdvice {
	...
	@Before("execution(* kr.or.shi.*.service.*.*(..)) or "
			+ "execution(* kr.or.shi.*.dao.*.*(..))")				/* kr.or.shi.*.service 하위 패키지와 kr.or.shi.*.dao 패키지  하위의 모든 클래스의 메소드 호출전 advice를 적용하도록 설정함. */	
	...
	@After("execution(* kr.or.shi.*.service.*.*(..)) or "
			+ "execution(* kr.or.shi.*.dao.*.*(..))")				/* kr.or.shi.*.service 하위 패키지와 kr.or.shi.*.dao 패키지  하위의 모든 클래스의 메소드 호출후 advice를 적용하도록 설정함. */	
	...
	@Around("execution(* kr.or.shi.*.service.*.*(..)) or "
			+ "execution(* kr.or.shi.*.dao.*.*(..))")
